...
// let firstName = prompt("Adınızı giriniz : ").toLowerCase();
// let sonKarakter = firstName[firstName.length - 1];
// let sondanbironceki = firstName[firstName.length - 2];
// let kalinSesli = ["a" , "ı" , "o" , "u"] ;
// let inceSesli = ["e" , "i" , "ö" , "ü"];
// let sertSessiz = ["p" , "ç" , "t" , "k" , "ş" , "f" , "s", "h"];

// function sevgilerle(firstName) {
//     if ( sertSessiz.includes(sonKarakter) &&  kalinSesli.includes(sondanbironceki) ) {
//         return `${firstName}'tan Sevgilerle`;
//     } else if ( sertSessiz.includes(sonKarakter) && inceSesli.includes(sondanbironceki)) {
//         return `${firstName}'ten Sevgilerle`;
//     }else if ( kalinSesli.includes(sonKarakter) || kalinSesli.includes(sondanbironceki)) {
//         return `${firstName}'dan Sevgilerle`;
//     } else if (inceSesli.includes(sonKarakter) || inceSesli.includes(sondanbironceki)) {
//         return `${firstName}'den Sevgilerle`;
//     } else {
//         return `lütfen geçerli bir isim giriniz`;
//     }
// }
// console.log(sevgilerle(firstName));
